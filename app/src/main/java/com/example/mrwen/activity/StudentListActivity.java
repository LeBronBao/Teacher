...
//        });
    ...
    private void initData() {
        ...
        final Call<ArrayList<StudentAndStudy>> call = getStudentList.getStudentList(StaticInfo.currentClassId);
        call.enqueue(new Callback<ArrayList<StudentAndStudy>>() {
            ...
            public void onFailure(Call<ArrayList<StudentAndStudy>> call, Throwable t) {
                alertDialog.showAlertDialog(StudentListActivity.this,t.toString());
            }
        });
    }
}
