...
public class CourseInfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_course_check_courseName.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                myDialog.showSingleLineInputDialog(CourseInfoActivity.this,"修改课程名称",tv_course_check_courseName.getText().toString(),tv_course_check_courseName);
            }
        });
        ...
        tv_course_check_subject.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                myDialog.showSingleLineInputDialog(CourseInfoActivity.this,"修改课程科目",tv_course_check_subject.getText().toString(),tv_course_check_subject);
            }
        });
        ...
        tv_course_check_grade.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                myDialog.showSingleLineInputDialog(CourseInfoActivity.this,"修改适用年级",tv_course_check_grade.getText().toString(),tv_course_check_grade);
            }
        });

        //修改课程种类
        tv_course_check_major.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                myDialog.showSemesterSelectDialog(CourseInfoActivity.this,"修改课程种类",tv_course_check_major.getText().toString(),tv_course_check_major);
            }
        });

        //修改适用学期
        tv_course_check_semester.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                myDialog.showSemesterSelectDialog(CourseInfoActivity.this,"修改适用学期",tv_course_check_semester.getText().toString(),tv_course_check_semester);
            }
        });
        ...
        tv_course_check_description.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                myDialog.showSingleLineInputDialog(CourseInfoActivity.this,"修改课程介绍",tv_course_check_description.getText().toString(),tv_course_check_description);
            }
        });
    }
    ...
    private Map<String,String> getInfo(){
        ...
        semester=tv_course_check_semester.getText().toString();
        major=tv_course_check_major.getText().toString();
            ...
            call.enqueue(new Callback<UniversalResult>() {
                ...
                public void onResponse(Call<UniversalResult> call, Response<UniversalResult> response) {
                    if(response.body().getResultCode()==1){
                        ...
                        alertDialog.showAlertDialog(CourseInfoActivity.this,"上传失败");
                    }
                }

                @Override
                public void onFailure(Call<UniversalResult> call, Throwable t) {
                    alertDialog.showAlertDialog(CourseInfoActivity.this,t.toString());
                }
            });
        }
        else
    ...
    private void retrofitGetSingleCourseInfo(){
        ...
        Log.i("currentCourseIddddd",StaticInfo.currentCourseId+"");
        call.enqueue(new Callback<Course>() {
            ...
            public void onResponse(Call<Course> call, Response<Course> response) {
                ...
                if(course!=null) {
                    ...
                    tv_course_check_chapterNumber.setText(String.valueOf(course.getChapterNumber()));
                    ...
                    if (course.getCoverURL() != null)
                        Glide.with(CourseInfoActivity.this).load(getResources().getString(R.string.baseURL) + course.getCoverURL()).into(iv_course_check_cover);
                }
            }
    ...
    private void retofitCourseInfoRevise(){
        ...
        call.enqueue(new Callback<UniversalResult>() {
            ...
            public void onResponse(Call<UniversalResult> call, Response<UniversalResult> response) {
                ...
                if(resultCode==1){
                    new AlertDialog.Builder(CourseInfoActivity.this).setTitle("提示")
                            .setMessage("保存课程信息成功")
