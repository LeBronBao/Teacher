            ...
            call.enqueue(new Callback<UniversalResult>() {
                ...
                public void onResponse(Call<UniversalResult> call, Response<UniversalResult> response) {
                    if(response.body().getResultCode()==1){
                        ...
                        alertDialog.showAlertDialog(PersonInfoFillActivity.this,"上传头像失败");
                    }
                }

                @Override
                public void onFailure(Call<UniversalResult> call, Throwable t) {
                    alertDialog.showAlertDialog(PersonInfoFillActivity.this,t.toString());
                }
            });
        }
    }
        ...
        call.enqueue(new Callback<RegisterResult>() {
            ...
            public void onResponse(Call<RegisterResult> call, Response<RegisterResult> response) {
                if(response.body().getResultCode()==1){
                    ...
                    alertDialog.showAlertDialog(PersonInfoFillActivity.this,"注册失败");
                }
